# CLAUDE.md — working in mcpwarden

Guidance for Claude Code (and contributors) working in this repo. The **product direction**
...
run       →  the launcher Claude Code actually spawns: resolves vaultwarden:// at spawn,
